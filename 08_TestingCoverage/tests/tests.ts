...
#test pop
    ...
    ck_assert_msg(buf_pop(a) == 1.4f, "pop 3");
    buf_trunc(a, 3);
    ck_assert_msg(buf_size(a) == 3, "size 3");
    ck_assert_msg(buf_pop(a) == 1.3f, "pop 2");
    ck_assert_msg(buf_pop(a) == 1.2f, "pop 1");
    ck_assert_msg(buf_pop(a) == 1.1f, "pop 0");
